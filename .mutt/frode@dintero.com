...
macro index O "<shell-escape>offlineimap-multi<enter>"           "run offlineimap to sync all mail"
macro index o "<shell-escape>offlineimap-multi -qf INBOX<enter>" "run offlineimap to sync inbox"
